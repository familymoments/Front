function TOS1 (){
    return(<div>
        <div>서비스 이용 약관
Family Moments에 오신 것을 환영합니다!

저희가 명시적으로 별도의 약관(본 약관이 아님)이 적용된다고 밝히지 않는 한 본 이용 약관(또는 '약관')이 회원님의 Family Moments 사용에 적용되며 아래 설명된 Family Moments 서비스('서비스')에 대한 정보를 제공합니다. 회원님이 Family Moments 계정을 만들거나 Family Moments을 이용하는 경우, 회원님은 본 약관에 동의하는 것으로 간주됩니다. 

Family Moments 서비스
저희는 회원님에게 Family Moments 서비스를 제공하는 것에 동의합니다. 서비스에는 저희가 Family Moments의 사명을 실현하기 위해 제공하는 모든 Family Moments 제품, 기능, 앱, 서비스, 기술, 소프트웨어가 포함됩니다. Family Moments은 회원님이 사랑하는 가족들과 서로의 일상을 더 가까이 접할 기회를 마련하는 것을 사명으로 삼습니다. 저희의 서비스는 다음과 같은 부분으로 구성됩니다.
•연결, 소통, 공유를 위한 맞춤화된 기회를 제공합니다. 저희는 회원님이 Family Moments 안팎에서 일상을 공유하고, 가족들과 소통하는 데 도움이 되는 여러 가지 기능을 제공합니다. 저희는 또한 회원님이 실제로 관심을 가지는 경험을 공유함으로써 관계를 강화하길 원합니다. 
•긍정적이고 포괄적이며 안전한 환경을 조성합니다. 저희는 저희 커뮤니티 회원들이 도움을 필요로 한다고 생각하는 경우를 포함하여 회원들의 경험을 긍정적이고 폭넓게 만들도록 도구를 개발 및 사용하고, 자원을 제공합니다. 또한 저희는 저희 약관 및 정책의 남용 및 위반과 유해하고 사기적인 행위를 방지하기 위한 시스템을 갖추고 있습니다. 저희는 저희 플랫폼의 보안을 유지하기 위해 저희가 보유한 모든 정보(회원님의 정보 포함)를 이용합니다. 개인정보처리방침에서 자세히 알아보세요.
•성장하고 있는 저희 커뮤니티에 지속적으로 서비스를 제공하는 데 도움이 되는 기술을 개발하고 사용합니다. 성장하고 있는 저희 커뮤니티를 위해 정보를 구성하고 분석하는 것이 저희 서비스의 핵심입니다. 
•연구 및 혁신. 저희는 보유하고 있는 정보를 이용하여 저희 서비스를 연구하고, 다른 사람들과 협력하여 저희 서비스를 보다 개선하고 저희 커뮤니티의 복지에 기여하기 위한 연구를 수행합니다.



개인정보처리방침
저희 서비스를 제공하기 위해서 회원님의 정보를 수집하고 이용해야 합니다. 개인정보처리방침은 저희가 정보를 수집, 이용하고 공유하는 방법에 대해 설명합니다. 또한 Family Moments 개인정보 보호 및 보안 설정을 포함해 회원님이 회원님의 정보를 관리할 수 있는 여러 방법에 대해 설명합니다. Family Moments을 사용하려면 개인정보처리방침에 동의해야 합니다.

회원님의 약속
서비스 제공에 대한 저희의 약속에 상응하여 회원님은 다음과 같은 약속을 해주셔야 합니다.
Family Moments을 이용할 수 있는 주체. 저희는 Family Moments 서비스가 가능한 개방적이고 포괄적인 서비스가 되기를 원하지만, 또한 본 서비스가 안전하고, 보안성을 갖추며, 법을 준수하는 서비스가 되기를 원합니다. 따라서 회원님이 Family Moments 커뮤니티에 참여하려면 몇 가지 제한 사항을 준수해야 합니다.
•관련 법률에 따라 Family Moments 서비스를 받는 것이 일부라도 금지된 사람 또는 관련 제재 대상 명단에 있어 결제 관련 Family Moments 서비스를 이용하는 것이 금지된 사람이 아니어야 합니다.
•과거에 저희가 회원님의 계정을 법률 또는 Family Moments 정책 위반을 이유로 하여 비활성화한 적이 없어야 합니다.
•유죄 확정판결을 받은 성범죄자가 아니어야 합니다.
Family Moments을 사용할 수 없는 경우. 
광범위한 커뮤니티에 안전하고 개방적인 Family Moments 서비스가 제공되기 위해서는 우리 모두가 각자의 본분을 다해야 합니다.
•다른 사람을 사칭하거나 부정확한 정보를 제공하면 안 됩니다.
Family Moments에서 회원님의 신원을 공개할 필요는 없지만, 회원님은 저희에게 정확한 최신 정보(등록 정보 포함)를 제공해야 하며 개인정보를 제공해야 할 수도 있습니다. 또한 본인이 아닌 다른 사람이나 단체를 사칭해서는 안 되며, 다른 사람의 명시적인 허락 없이 다른 사람의 이름으로 계정을 만들 수 없습니다.
•불법적이거나, 오해의 소지가 있거나, 사기적인 행위 또는 불법적이거나 허가받지 않은 목적을 위한 어떠한 행위도 하면 안 됩니다.
•특히 회원님은 Family Moments 커뮤니티 가이드라인을 포함하여 본 약관 또는 저희 정책을 위반할 수 없으며, 다른 사람들이 이를 위반하도록 돕거나 조장해서도 안 됩니다.
...
회원님은 저희에게 회원님의 사용자 이름, 프로필 사진 및 회원님의 활동(예: '좋아요')에 관한 정보를 제품 전반에 표시되는 계정, 광고, 제안 및 회원님이 팔로우하거나 참여하는 기타 홍보 콘텐츠와 함께 또는 이와 관련하여 표시할 수 있는 권한을 무상으로 부여합니다. 
...
본 약관 개정
저희는 Family Moments 서비스 및 정책을 변경할 수 있고, Family Moments 서비스 및 정책이 정확하게 반영되도록 하기 위해 본 약관을 변경해야 할 경우가 있습니다. 법적으로 달리 요구되지 않는 한 저희는 본 약관을 변경하기 전에 회원님에게 알리고, 개정된 약관의 효력이 발생되기 최소 30일 전에 회원님에게 이를 검토할 기회를 제공합니다. 변경 발효일 이후에도 회원님이 계속 Family Moments 서비스를 이용하실 경우, 회원님은 개정된 약관의 적용을 받게 됩니다. 본 약관 또는 개정된 약관에 동의하지 않을 경우에는 여기서 회원님의 계정을 삭제하면 됩니다.


--------------------------------------------------------------------------------------------------------------
개인정보처리동의서
FamilyMoments은(는) 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하며 귀하의 개인정보보호에 최선을 다하고 있습니다. 회사는 개인정보보호법에 근거하여 다 음과 같은 내용으로 개인정보를 수집 및 처리하고자 합니다.
...
제4조(동의 거부 관리)
귀하는 본 안내에 따른 개인정보 수집• 이용에 대하여 동의를 거부할 권리가 있습니다. 다만, 귀하가 개 인정보 동의를 거부하시는 경우에 서비스 이용제한의 불이익이 발생할 수 있음을 알려드립니다.
